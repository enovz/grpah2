...
/*export function Settings(canvas, axis) {
    ...
    let dataPointsRadius = 1; //Math.floor(dataPointsX / 4);
    //test
...
/*export function Settings(canvas, axis) {
    ...
    //dataPoints
    let dataPointsY = Math.floor((height / axis.rows) / ratio);
    let dataPointsX = Math.floor((width / axis.collumns) / ratio);
    ...
    if (ratio > 1) {
        dataPointsY = Math.floor((height / axis.rows) / ratio);
        dataPointsX = Math.floor((width / axis.collumns) / ratio)
